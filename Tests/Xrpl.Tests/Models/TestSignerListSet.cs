...
namespace XrplTests.Xrpl.Models
{
    ...
    {
        public static Dictionary<string, object> signerListSetTx;

        [ClassInitialize]
        public static void MyClassInitialize(TestContext testContext)
        {
            signerListSetTx = new Dictionary<string, object>
            {
                {"Flags", 0u},
                ...
                {"Fee", "12"},
                {"SignerQuorum", 3u},
                {"SignerEntries",new List<object>()
                {
                    new Dictionary<string,object>()
                    {
                        { "SignerEntry", new Dictionary<string,object>()
                            {
