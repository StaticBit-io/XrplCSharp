...
namespace XrplTests.Xrpl.Models
{
    ...
    public class TestUAMMWithdraw
    {
        ...
        public void TestVerifyValid()
        {
            ...
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: missing field Asset");
            withdraw["Asset"] = new Dictionary<string, object>() { { "currency", "XRP" } };
            //throws w/ Asset must be an Issue
            withdraw["Asset"] = 1234;
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: Asset must be an Issue");
            withdraw["Asset"] = new Dictionary<string, object>() { { "currency", "XRP" } };

            //throws w/ missing field Asset2
            withdraw.Remove("Asset2");
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: missing field Asset2");
            withdraw["Asset2"] = new Dictionary<string, object>() { { "currency", "XRP" } };
            //throws w/ Asset must be an Issue
            withdraw["Asset2"] = 1234;
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: Asset2 must be an Issue");
            ...
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: must set Amount with Amount2");
            withdraw.Remove("Amount2");

            //throws w/ must set Amount with EPrice
            withdraw["EPrice"] = "25";
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: must set Amount with EPrice");
            withdraw.Remove("EPrice");

            //throws w/ LPTokenIn must be an IssuedCurrencyAmount
            withdraw["LPTokenIn"] = 1234;
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: LPTokenIn must be an IssuedCurrencyAmount");
            withdraw.Remove("LPTokenIn");

            //throws w/ Amount must be an Amount
            withdraw["Amount"] = 1234;
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: Amount must be an Amount");
            withdraw.Remove("Amount");

            //throws w/ Amount2 must be an Amount
            withdraw["Amount"] = "1000";
            withdraw["Amount2"] = 1234;
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: Amount2 must be an Amount");
            withdraw.Remove("Amount");
            withdraw.Remove("Amount2");
            ...
            Helper.ThrowsException<ValidationException>(() => Validation.Validate(withdraw), "AMMWithdraw: EPrice must be an Amount");
            withdraw.Remove("Amount");
            withdraw.Remove("EPrice");
