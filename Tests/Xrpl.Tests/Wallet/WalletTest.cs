...
namespace Xrpl.Tests.Wallet.Tests.Sign
{
    ...
    public class TestUSign
    {
        ...
        Dictionary<string, object> requestJson = JsonConvert.DeserializeObject<Dictionary<string, object>>(requestFixture);
        ...
        Dictionary<string, object> responseJson = JsonConvert.DeserializeObject<Dictionary<string, object>>(responseFixture);
        ...
        public void TestSignSuccessful()
        {
            ...
            JObject some = (JObject)((JObject)requestJson["sign"])["normal"];
            SignatureResult result = wallet.Sign(some.ToObject<Dictionary<string, object>>());
            Assert.AreEqual(result.TxBlob, (string)((JObject)((JObject)responseJson["sign"])["normal"])["signedTransaction"]);
        ...
        {
            var wallet = XrplWallet.FromSeed("ss1x3KLrSvfg7irFc1D929WXZ7z9H");
            JObject some = (JObject)((JObject)requestJson["sign"])["escrow"];
            SignatureResult result = wallet.Sign(some.ToObject<Dictionary<string, object>>());
            Assert.AreEqual(result.TxBlob, (string)((JObject)((JObject)responseJson["sign"])["escrow"])["signedTransaction"]);
        ...
        public void TestSignPaymentNoFlags()
        {
            ...
            System.Text.Json.Nodes.JsonNode decoded = XrplBinaryCodec.Decode(result.TxBlob);
        ...
        public void TestSignPaymentSourceDestMin()
        {
            ...
            Dictionary<string, object> tx = new Dictionary<string, object>
            {
                ...
                { "Flags", 2147614720 },
                { "SendMax", new Dictionary<string, object> {
                   { "currency", "GBP" },
                   { "issuer", "rpat5TmYjDsnFSStmgTumFgXCM9eqsWPro" },
                   { "value", "0.1" }
                } },
                { "DeliverMin", new Dictionary<string, object> {
                   { "currency", "USD" },
                   { "issuer", "rMaa8VLBTjwTJWA2kSme4Sqgphhr6Lr6FH" },
            ...
            SignatureResult result = wallet.Sign(tx);
            System.Text.Json.Nodes.JsonNode decoded = XrplBinaryCodec.Decode(result.TxBlob);
            Assert.AreEqual(2147614720u, decoded["Flags"].GetValue<uint>());
        ...
        {
            var wallet = XrplWallet.FromSeed("ss1x3KLrSvfg7irFc1D929WXZ7z9H");
            JObject some = (JObject)((JObject)requestJson["sign"])["ticket"];
            SignatureResult result = wallet.Sign(some.ToObject<Dictionary<string, object>>());
            Assert.AreEqual(result.TxBlob, (string)((JObject)((JObject)responseJson["sign"])["ticket"])["signedTransaction"]);
        ...
        private Dictionary<string, object> icPayment = new Dictionary<string, object>
        {
            { "TransactionType", "Payment" },
            { "Account", "r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59" },
            { "Destination", "rQ3PTWGLCbPz8ZCicV5tCX3xuymojTng5r" },
        ...
        public void TestSignICLowerCase()
        {
            ...
            Dictionary<string, object> payment = icPayment;
            payment["Amount"] = new Dictionary<string, object> {
                { "currency", "foo" },
                { "issuer", "rnURbz5HLbvqEq69b1B4TX6cUTNMmcrBqi" },
                { "value", "123.40" }
            };
        ...
        public void TestSignStdHex()
        {
            ...
            Dictionary<string, object> payment2 = icPayment;
            payment2["Amount"] = new Dictionary<string, object> {
        ...
        //    Dictionary<string, object> nfttx = new Dictionary<string, object>
        //    {
        ...
        //        { "Memos", new Dictionary<string, object> {
...
namespace Xrpl.Tests.Wallet.Tests.Verify
{
    ...
    public class TestUVerify
    {
        ...
        private Dictionary<string, object> prepared = new Dictionary<string, object>
        {
        ...
        public void TestVerifySameWallet()
        {
            ...
            bool isVerified = wallet.VerifyTransaction((string)prepared["signedTransaction"]);
