...
namespace Xrpl.Tests.ClientLib
{
    ...
    public class TestUAutofill
    {
        ...
        public async Task TestAutofillXAddress()
        {
            ...
            Dictionary<string, object> accountInfoData = JsonSerializer.Deserialize<Dictionary<string, object>>(accountInfoString);
            ...
            Dictionary<string, object> ledgerData = JsonSerializer.Deserialize<Dictionary<string, object>>(ledgerString);
        ...
        public void TestAutofillDeteteBlockers()
        {
            ...
            Dictionary<string, object> accountObjectsData = JsonSerializer.Deserialize<Dictionary<string, object>>(accountObjectsString);
        ...
        public async Task TestAutofillDelete()
        {
            ...
            Dictionary<string, object> serverStateData = JsonSerializer.Deserialize<Dictionary<string, object>>(serverStateString);
