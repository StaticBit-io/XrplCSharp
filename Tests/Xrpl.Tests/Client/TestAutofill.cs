...
namespace Xrpl.Tests.ClientLib
{
    ...
    public class TestUAutofill
    {
        ...
        public async Task TestAutofillXAddress()
        {
            ...
            Dictionary<string, object> accountInfoData = JsonConvert.DeserializeObject<Dictionary<string, object>>(accountInfoString);
            ...
            Dictionary<string, object> ledgerData = JsonConvert.DeserializeObject<Dictionary<string, object>>(ledgerString);
            ...
            Dictionary<string, object> serverInfoData = JsonConvert.DeserializeObject<Dictionary<string, object>>(serverInfoString);
        ...
        public async Task TestAutofillSequence()
        {
            ...
            Dictionary<string, object> txResult = await runner.client.Autofill(tx);
            Assert.IsTrue(23 == Convert.ToInt32(txResult["Sequence"]));
        }
        ...
        public void TestAutofillDeteteBlockers()
        {
            ...
            Dictionary<string, object> accountObjectsData = JsonConvert.DeserializeObject<Dictionary<string, object>>(accountObjectsString);
        ...
        public async Task TestAutofillFee()
        {
            ...
            Dictionary<string, object> txResult = await runner.client.Autofill(tx);
            Assert.AreEqual("12", (string)txResult["Fee"]);
        }
        ...
        public async Task TestAutofillEscrowFinish()
        {
            ...
            Dictionary<string, object> txResult = await runner.client.Autofill(tx);
            Assert.AreEqual("399", (string)txResult["Fee"]);
        }
        ...
        public async Task TestAutofillDelete()
        {
            ...
            Dictionary<string, object> serverStateData = JsonConvert.DeserializeObject<Dictionary<string, object>>(serverStateString);
            ...
            Dictionary<string, object> txResult = await runner.client.Autofill(tx);
            Assert.AreEqual("2000000", (string)txResult["Fee"]);
        }
        ...
        public async Task TestAutofillLastLedger()
        {
            ...
            Dictionary<string, object> txResult = await runner.client.Autofill(tx);
            Assert.IsTrue(9038234 == Convert.ToInt32(txResult["LastLedgerSequence"]));
        }
    }
}
