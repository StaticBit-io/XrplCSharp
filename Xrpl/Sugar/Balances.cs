...
namespace Xrpl.Sugar
{
    ...
    public static class BalancesSugar
    {
        ...
        extension(IXrplClient client)
        {
            ...
            public async Task<string> GetXrpBalance(string address, string ledgerHash = null, LedgerIndex lederIndex = null)
            {
            ...
            public async Task<decimal> GetXrpFreeBalance(string address, string? ledgerHash = null, LedgerIndex? lederIndex = null)
            {
                LedgerIndex index = new LedgerIndex(LedgerIndexType.Validated);
                AccountInfoRequest xrpRequest = new AccountInfoRequest(address)
                {
            ...
            public async Task<List<Balance>> GetBalances(string address, GetBalancesOptions options = null)
            {
